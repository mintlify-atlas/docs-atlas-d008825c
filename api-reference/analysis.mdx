...
description: "REST endpoints for creating startup analyses, polling progress, retrieving reports, regenerating sections, AI chat, and plan usage management."
---
...
Returns only the `ideaAnalysis` section of a completed analysis — a lightweight alternative to fetching the full record when you only need the core idea breakdown.
...
<ResponseField name="coreProblem" type="string">
  The core problem the idea is solving.
</ResponseField>

<ResponseField name="targetUsers" type="string[]">
...
```json 200 Response
{
  "summary": "A B2B SaaS platform that uses machine learning to predict customer churn in subscription businesses.",
  "coreProblem": "Subscription businesses lose revenue through undetected customer churn before retention can be applied.",
  "targetUsers": ["Customer success managers", "SaaS founders", "Revenue operations teams"],
  "industry": "Customer Success / SaaS Analytics",
  "useCases": [
    "Early churn detection and alerting",
...
```json 200 Response — not yet generated
null
```
