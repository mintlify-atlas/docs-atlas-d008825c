---
title: "AI Startup Analyzer REST API Reference and Overview"
sidebarTitle: "Overview"
description: "Complete REST API reference: base URL, JWT cookie auth, content type, error codes, rate limits, and quick-start curl examples for AI Startup Analyzer."
---
