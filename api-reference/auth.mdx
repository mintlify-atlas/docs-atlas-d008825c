---
title: "Auth Endpoints: Register, Login, OAuth"
sidebarTitle: "Auth Endpoints"
description: "REST endpoints for user registration, login, token refresh, logout, Google OAuth, and current user profile in AI Startup Analyzer."
---
