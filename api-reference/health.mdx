---
title: "GET /health — Health Check Endpoint"
sidebarTitle: "Health Check"
description: "GET /health returns the API server status. Use this endpoint for uptime monitoring, load balancer health checks, and container readiness probes."
---
