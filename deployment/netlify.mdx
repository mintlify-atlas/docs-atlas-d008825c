---
title: "Deploy AI Startup Analyzer Frontend to Netlify Guide"
sidebarTitle: "Netlify"
description: "Deploy the AI Startup Analyzer Next.js frontend to Netlify. Covers build command, publish directory, and the NEXT_PUBLIC_API_URL environment variable."
---
