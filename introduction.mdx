---
title: "AI Startup Analyzer: Multi-Agent Startup Idea Analysis Platform"
...
Every analysis triggers all 14 agents. The first six run concurrently on the raw idea; the remaining eight run concurrently once those results are available, using the Phase 1 outputs as grounding context.
