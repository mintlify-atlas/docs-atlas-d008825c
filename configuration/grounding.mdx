...
description: "Understand AI Startup Analyzer's grounding system that validates and improves final report quality using rule-based and AI-based strategies controlled by environment flags."
---
